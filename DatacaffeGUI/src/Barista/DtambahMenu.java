    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        ...
        try {
            if (bahan.isEmpty() || satuan.isEmpty() || kadaluarsa.isEmpty() || jumlah.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Isi Form semua MasPur!!");
                return;
            }
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Jumlah harus angka valid MasPur!");
                return;
            }
            ...
            try {
                ...
                if (tanggalKadaluarsa.isBefore(LocalDate.now())) {
                    JOptionPane.showMessageDialog(this, "Tanggal kadaluarsa sudah lewat MasPur!");
                    return;
                }
            } catch (DateTimeParseException e) {
                JOptionPane.showMessageDialog(this, "Format tanggal kadaluarsa salah\nharus yyyy-MM-dd MasPur!");
                return;
            }
